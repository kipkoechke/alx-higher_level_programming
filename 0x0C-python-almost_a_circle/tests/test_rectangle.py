...
class TestRectangleWidth(unittest.TestCase):
    ...
    def test_complex_width(self):
        with self.assertRaisesRegex(TypeError, "width must be an integer"):
            Rectangle(complex(5), 1)

    def test_dict_width(self):
        with self.assertRaisesRegex(TypeError, "width must be an integer"):
            Rectangle({"invalid": 5}, 2)
    ...
    def test_positive_width(self):
        self.assertEqual(1, Rectangle(1, 1).width)
...
class TestRectangleHeight(unittest.TestCase):
    ...
    def test_positive_height(self):
        self.assertEqual(1, Rectangle(1, 1).height)
...
class TestRectangleX(unittest.TestCase):
    ...
    def test_None_x(self):
        with self.assertRaisesRegex(TypeError, "x must be an integer"):
            Rectangle(2, 2, None, 2)

    def test_str_x(self):
        with self.assertRaisesRegex(TypeError, "x must be an integer"):
            Rectangle(2, 2, "invalid", 2)
    ...
    def test_complex_x(self):
        with self.assertRaisesRegex(TypeError, "x must be an integer"):
            Rectangle(2, 2, complex(5), 2)

    def test_dict_x(self):
        with self.assertRaisesRegex(TypeError, "x must be an integer"):
            Rectangle(2, 2, {"invalid": 5}, 2)

    def test_list_x(self):
        with self.assertRaisesRegex(TypeError, "x must be an integer"):
            Rectangle(2, 2, [1, 2, 3], 2)
    ...
    def test_positive_x(self):
        self.assertEqual(1, Rectangle(2, 2, 1, 2).x)
...
class TestRectangleY(unittest.TestCase):
    ...
    def test_complex_y(self):
        with self.assertRaisesRegex(TypeError, "y must be an integer"):
            Rectangle(2, 2, 2, complex(5))

    def test_dict_y(self):
        with self.assertRaisesRegex(TypeError, "y must be an integer"):
            Rectangle(2, 2, 2, {"invalid": 5})
    ...
    def test_positive_y(self):
        self.assertEqual(1, Rectangle(2, 2, 2, 1).y)

class TestRectangleOrderOfInitialization(unittest.TestCase):
    """Unittests for testing the order of instantiation of Rectangle attributes."""
