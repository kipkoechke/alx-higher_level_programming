...
class Base:
    ...
    def create(cls, **dictionary):
        """Create an instance using attributes from a dictionary.
    ...
    def load_from_file(cls):
        """Load a list of instances from a JSON file named after the class.
    ...
    def save_to_file_csv(cls, list_objs):
        """Serialize a list of objects to CSV and write to a file.
    ...
    def load_from_file_csv(cls):
        """Deserialize a list of objects from a CSV file and return them.
